...
import 'package:musixc/Ui/chart_details.dart';
import 'package:musixc/Ui/chart_list.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<ChartBloc>(
      create: (context)=>ChartBloc()..add(ChartEvent.chartlistevent()),
      child: BlocConsumer<ChartBloc,ChartState>(
        ...
        builder: (_,state){
          return state.when(
              ...
              loading: ()=> preloading(),
              successlist: (s)=>Chart_list_page(list: s.response,),
              successdetails: (s)=> details(ly: s.respons2,track: s.response,) ,
